...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-h8rvcjs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-h8rvcjs.containers.anotherwebservice.com/
...
```
git clone git@github.com:brickist/container-h8rvcjs.git
cd container-h8rvcjs
```
...
```
docker attach container-h8rvcjs
```
